...
SIN FAVORITISMOS: cébate IGUAL O MÁS con España, con los favoritos y con los cracks de moda. Y especialmente con los de la porra que coronaron a España campeona (el rebaño): si España pincha, ridículo absoluto y a recordarles que hicieron el primo siguiendo a la manada; si gana sufriendo o aburriendo, también caña. Nada de tratar a la favorita con guantes de seda. (El roast va siempre por el fútbol y por la porra, nunca por raza, religión ni nacionalidad de la gente.)'''
...
_REGLA = '''MUY IMPORTANTE: lo único sagrado son los DATOS (marcadores, goleadores, minutos, puntos de la porra): esos son SOLO los que aparecen en los HECHOS REALES y no se inventan (los motes/apodos sí los puedes buscar en internet). Pero las OPINIONES, exageraciones, hot takes, morbo y pullas son LIBRES: ahí pícate todo lo que quieras. Devuelve SOLO el markdown del artículo, sin comentarios, sin explicaciones y sin ```.'''
